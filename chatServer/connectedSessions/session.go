...
func (session *session) SetUser(sessionUniqueId uint64, userID []byte, curTimeSec int64) {
	session.setUserID(userID)
	session.setRoomNumber(sessionUniqueId, -1, curTimeSec)
}
