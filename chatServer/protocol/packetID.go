...
const (
	...
	PACKET_ID_ROOM_WHISPER_REQ = 734
	PACKET_ID_ROOM_WHISPER_NTF = 735

	PACKET_ID_ROOM_RELAY_REQ = 741
	PACKET_ID_ROOM_RELAY_NTF = 742

	PACKET_ID_ROOM_INVITE_REQ = 751
	PACKET_ID_ROOM_INVITE_RES = 752
	PACKET_ID_ROOM_INVITE_NOTIFY = 753
